...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Archivo+Black&family=Cardo:ital,wght@0,400;0,700;1,400&family=Tenor+Sans&display=swap" rel="stylesheet">
...
<div id="barba-wrapper">
	      ...
	      <nav id="site-navigation" class="main-navigation flex w-100 justify-between items-center">
	        <a class="menu-toggle f6 archivo white ttu tracked block w4 link" href="#nav">
	          Places
	        </a>
